...
class _ReliationPrivacyState extends State<Reliationship> {
  ...
  Widget build(BuildContext context) {
    loggedInUser=widget.sessionId.id;
    about();
    return SafeArea(
      child: Scaffold(
          ...
          Flexible(
            child: Container(
              ...
              child: DropDownTextField(
                fieldName: AppTexts.RELATION_SHIP,
                data: AppTexts.RELATIONSHIP,
                callBack: (val) {
                  print(val);
                  status =val;
  ...
  updateUserProfile(String relation) async
  {
