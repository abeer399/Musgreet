...
class SearchFaithInterestsScreen extends StatefulWidget {
  @override
  _SearchFaithInterestsScreenState createState() => _SearchFaithInterestsScreenState();
}

class _SearchFaithInterestsScreenState extends State<SearchFaithInterestsScreen> {
    ...
    return Stack(
      children: [
        Container(
          ...
          height: 50,
          child: Text(
            AppTexts.SEARCH_FAITH_INTERESTS,
            style: TextStyle(
        ...
        children: [
          ...
          Flexible(
            child: Container(
              padding: EdgeInsets.only(left: 5, right: 5),
              child: DropDownTextField(
                fieldName: AppTexts.REVERT,
                data: AppTexts.REVERT_STATUS,
                callBack: (val) {
                  print(val);
                },
              ),
                ...
                children: [
                  Column(
                    ...
                    children: [
                      CustomSpacerWidget(height: 5,),
                      Text(
                        "Attending Mosques, Charity Work...",
                        //AppTexts.LANGUAGES,
                        style: TextStyle(
                          fontWeight: FontWeight.w700,
                          fontSize: 15,
