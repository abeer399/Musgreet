...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if(mosqueAdmin == true){
      if(widget.CallingScreen == "Mosque"){
  ...
  /// This Method is to save Mosque post in Database
  Future<void> _SaveMosquePost() async{
    print(_thoughtsController.text);
    print(S3ImageURL);
    print(postVisibility);
    print("inside Save Posts");
  ...
  _navigateToHome() {
    ...
    _navigateToMosqueDetailsScreen(){
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => MosquesDetailsScreen(sessionUser:widget.sessionUser,CallingScreen: "Create_Post")));
    }
