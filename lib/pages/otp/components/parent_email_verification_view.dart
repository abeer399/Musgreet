...
class ParentEmailVerificationView extends StatefulWidget {
  @override
  _ParentEmailVerificationViewState createState() =>
      _ParentEmailVerificationViewState();
}
...
class _ParentEmailVerificationViewState
  ...
  Widget build(BuildContext context) {
    ...
    args =
        ModalRoute.of(context).settings.arguments as ParentEmailArgumentClass;
    ...
    try {
      if (sessionUser != null) {
        final updatedItem = sessionUser.copyWith(
            parent_verification: true, parent_consent_form_agree: true);
  ...
  void _navigateToNextScreen(BuildContext context) {
    ...
    Navigation.intentWithData(context, AppRoutes.VERIFYADDRESS,
        AgeRegistrationArgumentClass(sessionUser));
  }
}
