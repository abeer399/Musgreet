...
class _HomeTabState extends State<HomeTab> {
                    ...
                    mosqueAdmin ? GestureDetector(
                      onTap: (){
                        ...
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: (context) => MosquePrayersUploadScreen(mosque: widget.mosque, sessionUser:widget.sessionUser)));
                      },
                      child: Padding(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          posts.length == 0 ?Container() :Padding(
            padding: const EdgeInsets.only(top: 24.0, left: 25),
            child: Text(
              'Top Post',
              style: TextStyle(
  ...
  _navigatetoCreatePost(){
    ...
    Navigator.of(context)
        .push(MaterialPageRoute(builder: (context) => CreatePostScreen(sessionUser:widget.sessionUser,CallingScreen: "Mosque",mosqueObject: widget.mosque[0],)));
