...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    args = ModalRoute.of(context).settings.arguments
        as CommunityPromiseArgumentClass;
    print("args");
    print(args);
    if (args == null) {
        ...
        switch (snapshot.connectionState) {
          case ConnectionState.done:
            ...
            return PostCardWidget(
              ...
              //callBack: () => _loadCommentScreen(Postss[index].id, User[0], Postss[index].post, Postss[index].post_image_path),
              callBack: () => _loadCommentScreen(
                  postData, UserData, CommentsCount.toString(), sessionUser),
              commentsCount: CommentsCount.toString(),
            );
          default:
            return _buildLoadingScreen();
  ...
  Future<void> updatePost() async {
    try {
      final updatedItem = Postss[3].copyWith(
          post:
              "Hi Friends! This is a new post added from APP visible to Community",
          post_image_path:
              "https://musgreetphase1images184452-staging.s3.eu-west-2.amazonaws.com/public/post_img.png",
    ...
    if (index == Postss.length - 1) {
      return Column(children: [
        PostCardWidget(
          ...
          //profileImage: Image.network('https://picsum.photos/250?image=9'),
          profileImage:
              "https://musgreetphase1images184452-staging.s3.eu-west-2.amazonaws.com/public/public.png",
          //name: AppTexts.TEMP_NAME1,
          //name: Postss[index].usersID,
          //name: UserObject.first_name,
          //name: UserObjectList[0].first_name,
