  ...
  _screenNavigation(int index){
    ...
    switch (index) {
      ...
      case 1:
        ...
        if(mosqueAdmin == true){
          Navigator.push(context,
              MaterialPageRoute(
                  builder: (context) => MosquesDetailsScreen(sessionUser: widget.sessionUser,)));
          //MosqueSearchListView(CallingScreen: widget.CallingScreen,sessionUser: widget.sessionUser)
        }
        else{
      ...
      //Navigation.intent(context, AppRoutes.CREATE_POST_SCREEN);
        ...
        break;
      case 3:
        Navigation.intent(context, AppRoutes.CHAT);
         /*Navigator.push(context,
             MaterialPageRoute(
