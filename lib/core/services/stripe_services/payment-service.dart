...
class StripeService {
  ...
  static String secret = 'sk_test_51JP6JmI4ViauatGSdJUJ3clFsqhM3mlJIrSgqWWBoz'
      'uoluHxAG2hH9BzAnb9CjICcyDQtCqMgyfwWAAg3ZidfefA005Wu27Imu';
  ...
  static init() {
    StripePayment.setOptions(
      StripeOptions(
        publishableKey: "pk_test_51JP6JmI4ViauatGSX8QA0chQ5RWtjTRATjirbuDlQb"
            "pfwm8NJxKR9kVkuuND0RRWSSGkCBafYlNcXfDFrpFoMr7y00Ip7D03Od",
        merchantId: "Test",
        androidPayMode: 'test'
      )
    );
