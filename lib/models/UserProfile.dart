...
class UserProfile extends Model {
  ...
  bool operator ==(Object other) {
    ...
    return other is UserProfile &&
        ...
        profile_photo_path == other.profile_photo_path &&
        cover_photo_path == other.cover_photo_path;
  }
  ...
  String toString() {
    ...
    buffer.write("profile_photo_path=" + "$profile_photo_path" + ", ");
    buffer.write("cover_photo_path=" + "$cover_photo_path");
    buffer.write("}");
  ...
  UserProfile copyWith(
    ...
    return UserProfile(
        ...
        cover_photo_path: cover_photo_path ?? this.cover_photo_path);
  }
  ...
  UserProfile.fromJson(Map<String, dynamic> json)
      : id = json['id'],
        ...
        cover_photo_path = json['cover_photo_path'];
  ...
  static final QueryField PROFILE_PHOTO_PATH =
      QueryField(fieldName: "profile_photo_path");
  static final QueryField COVER_PHOTO_PATH =
      QueryField(fieldName: "cover_photo_path");
  static var schema =
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
        key: UserProfile.PROFILE_PHOTO_PATH,
        isRequired: false,
        ofType: ModelFieldType(ModelFieldTypeEnum.string)));

    modelSchemaDefinition.addField(ModelFieldDefinition.field(
        key: UserProfile.COVER_PHOTO_PATH,
        isRequired: false,
        ofType: ModelFieldType(ModelFieldTypeEnum.string)));
  });
}
