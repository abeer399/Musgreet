...
Future<void> createPosts1() async {
  final item = Posts(
      ...
      post_image_path:
          "https://musgreetphase1images184452-staging.s3.eu-west-2.amazonaws.com/public/post_img_2.png",
...
Future<void> listMasterInterests1() async {
  try {
    List<MasterIntrests> MasterIntrestss =
        await Amplify.DataStore.query(MasterIntrests.classType);
...
Future<void> listUserProfile1() async {
  try {
    List<UserProfile> UserProfiles =
        await Amplify.DataStore.query(UserProfile.classType);
    print(UserProfiles);
  } catch (e) {
    print("Could not query DataStore: " + e);
  }
...
Future<void> listMosqueFollowers1() async {
  try {
    List<MosqueFollowers> MosqueFollowerss =
        await Amplify.DataStore.query(MosqueFollowers.classType);
    ...
    if (masterIntrest.isEmpty) {
      for (int i = 0; i < AppTexts.HOBIE_CATEGORIES.length; i++) {
        final hobbie = MasterIntrests(
            ...
            intrest_name: AppTexts.HOBIE_CATEGORIES.keys.elementAt(i),
            decription: "",
      ...
      for (int i = 0; i < AppTexts.SPORTS_EXERCISE_CATEGORIES.length; i++) {
        final sports = MasterIntrests(
            photo_path: AppTexts.SPORTS_EXERCISE_CATEGORIES.values.elementAt(i),
            intrest_name: AppTexts.SPORTS_EXERCISE_CATEGORIES.keys.elementAt(i),
            decription: "",
      ...
      for (int i = 0; i < AppTexts.FAMILY_OUTDOORS_CATEGORIES.length; i++) {
        final outdoors = MasterIntrests(
            photo_path: AppTexts.FAMILY_OUTDOORS_CATEGORIES.values.elementAt(i),
            intrest_name: AppTexts.FAMILY_OUTDOORS_CATEGORIES.keys.elementAt(i),
            decription: "",
      ...
      for (int i = 0; i < AppTexts.VOLUNTEER_CATEGORIES.length; i++) {
        final volunteer = MasterIntrests(
            photo_path: AppTexts.VOLUNTEER_CATEGORIES.values.elementAt(i),
            intrest_name: AppTexts.VOLUNTEER_CATEGORIES.keys.elementAt(i),
            decription: "",
      ...
      for (int i = 0;
          i < AppTexts.COMMUNITY_INVOLVEMENT_CATEGORIES.length;
          i++) {
        final community = MasterIntrests(
            photo_path:
                AppTexts.COMMUNITY_INVOLVEMENT_CATEGORIES.values.elementAt(i),
            intrest_name:
                AppTexts.COMMUNITY_INVOLVEMENT_CATEGORIES.keys.elementAt(i),
            decription: "",
      ...
      for (int i = 0; i < AppTexts.SKILLS_CATEGORIES.length; i++) {
        final skills = MasterIntrests(
            photo_path: AppTexts.SKILLS_CATEGORIES.values.elementAt(i),
            intrest_name: AppTexts.SKILLS_CATEGORIES.keys.elementAt(i),
            decription: "",
            category_name: "Skills");
      ...
      for (int i = 0; i < AppTexts.RELIGIONS_INTEREST_CATEGORIES.length; i++) {
        final religious = MasterIntrests(
            photo_path:
                AppTexts.RELIGIONS_INTEREST_CATEGORIES.values.elementAt(i),
            intrest_name:
                AppTexts.RELIGIONS_INTEREST_CATEGORIES.keys.elementAt(i),
            decription: "",
...
Future<void> createUserProfile() async {
  try {
    ...
    List<String> languages1 = [
      languagesList[3].languages + "," + languagesList[4].languages
    ];
    List<String> communityIntrest1 = [intrests[0].id + "," + intrests[1].id];
    List<String> skillsid = [skills[0].id + "," + skills[1].id];
    List<String> religiousId = [
      religiousIntrest[0].getId() + "," + religiousIntrest[1].getId()
    ];
    if (userProfile.isEmpty) {
      ...
      List<String> languages2 = [
        languagesList[0].languages + "," + languagesList[1].languages
      ];
      List<String> communityIntrest2 = [intrests[2].id + "," + intrests[3].id];
      List<String> skillsid2 = [skills[2].id + "," + skills[3].id];
      List<String> religiousId2 = [
        religiousIntrest[2].getId() + "," + religiousIntrest[3].getId()
      ];
      ...
      List<String> religiousId3 = [
        religiousIntrest[4].getId() + "," + religiousIntrest[5].getId()
      ];
